...
# 게임에서 사용할 캐릭터를 정의합니다.
define he = Character('나', color="#7BA518")
define she = Character('점순', color="#CE723D")
define jang = Character('장인어른', color="#BD5C24")
define cow = Character('소', color="#BD9424")
define gu = Character('구장', color="#B0D0D6")
define mung = Character('뭉태', color="#918EDB")
...
label start:
    ...
    he "점순이의 키 좀 크게 해줍소사. 그러면 담엔 떡 갖다 놓고 고사드립죠니까."
    ...
    jang "너 이 자식, 왜 또 이래 응?"
    
    he "배가 좀 아파서유!"
    
    jang "이 자식아, 일허다 말면 누굴 망해 놀 속셈이냐, 이 대가릴 까놀 자식?"
    ...
    jang "얘, 그만 일어나 일 좀 해라. 그래야 올 갈에 벼 잘 되면 너 장가들지 않니."
    
    he "!!!!"


    jang "이 자식아 미처 커야지. 조걸 무슨 혼인을 한다고 그러니 원!"
    ...
    he "난 갈 테야유, 그 동안 사경 쳐내슈"
    
    jang "너 사위로 왔지 어디 머슴 살러 왔니?"
    
    he "그러면 얼찐 성례를 해줘야 안 하지유. 밤낮 부려만 먹구 해준다 해준다……."
    
    
    jang "글쎄 내가 안 하는 거냐? 그년이 안 크니까……"
    

    '이렇게 따져 나가면 언제든지 늘 나만 밑지고 만다. 이번엔 안 된다 하고 대뜸 구장님한테로 판단 가자고 소맷자락을 내끌었다.'
    
    jang "아 이 자식아, 왜 이래 어른을."
    ...
    he "안야! 안야! 이 망할자식의 소(장인님의 소니까) 대리를 꺾어 줄라."
    ...
    jang " 아 성례구 뭐구 계집애년이 미처 자라야 할 게 아닌가?"
    '하니까 고만 멀쑤룩해서 입맛만 쩍쩍 다실 뿐이 아닌가. '
    gu "그것두 그래!"
    he "그래, 거진 사 년 동안에도 안 자랐다니 그 킨 은제 자라지유? 다 그만두구 사경 내슈……."
    jang "글쎄, 이 자식아! 내가 크질 말라구 그랬니, 왜 날 보구 떼냐?"
    he"빙모님은 참새만한 것이 그럼 어떻게 앨 낳지유?(사실 장모님은 점순이보다도 귀때기 하나가 작다.)" 
...
내가 일 안 하면 장인님 저는 나이가 먹어 못 하고 결국 농사 못 짓고 만다. 뒷짐으로 트림을 꿀꺽, 하고 대문 밖으로 나오다 날 보고서,'
    ...
    he "관격이 났어유, 아이구 배야!"
    jang "기껀 밥 처먹고 나서 무슨 관격이야, 남의 농사 버려 주면 이 자식아 징역 간다 봐라!"
    he "가두 좋아유, 아이구 배야!"
...
한번은 장인님이 헐떡헐떡 기어서 올라오더니 내 바짓가랑이를 요렇게 노리고서 단박 움켜잡고 매달렸다. 악, 소리를 치고 나는 그만 세상이 다 팽그르 도는 것이,  '
    ...
    he "빙장님! 빙장님! 빙장님!" 
    jang "이 자식! 잡아먹어라. 잡아먹어!" 
    he "아! 아! 할아버지! 살려 줍쇼, 할아버지!" 
...
내가 머리가 터지도록 매를 얻어맞은 것이 이 때문이다. 그러나 여기가 또한 우리 장인님이 유달리 착한 곳이다. 여느 사람이면 사경을 주어서라도 당장 내쫓았지 터진 머리를 볼솜으로 손수 지져 주고, 호주머니에 희연 한 봉을 넣어 주시고 그리고, '
    ...
    jang " 올 갈엔 꼭 성례를 시켜 주마. 암말 말구 가서 뒷골의 콩밭이나 얼른 갈아라." 
    he "빙장님! 인제 다시는 안 그러겠어유." 
    '하고 등을 뚜덕여 줄 사람이 누구냐. 
...
이렇게 꼼짝도 못하게 해놓고 장인님은 지게 막대기를 들어서 사뭇 내려조겼다. 그러나 나는 구태여 피하려지도 않고 암만해도 그 속 알 수 없는 점순이의 얼굴만 멀거니 들여다보았다. '
    ...
    jang "이 자식! 장인 입에서 할아버지 소리가 나오도록 해?"
